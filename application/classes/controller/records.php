<?php
    ...
    class records extends base_auth_controller {
        private $form;
        ...
        public function init() {
            parent::init();
            $this->view->set_view('template.phtml', ['topbar' => true, 'loginuser' => $this->session->loginuser, 'pagepath' => [['MAIN', '/main'], ['Records', '/records']]]);
        }
